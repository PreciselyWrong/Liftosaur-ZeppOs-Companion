...
The 0.5.3 extension also targets Free Training. Its Active 2 menu path and runtime behaviour remain UNKNOWN until the physical validation described in the hardware test plan. Strength Training installation on Active 3 Premium is TESTED (tester report), not a full compatibility certification.
...
**Version:** Lifto Companion 0.5.3 beta.

**Workout version:** Lifto Workout 0.5.3 beta.
