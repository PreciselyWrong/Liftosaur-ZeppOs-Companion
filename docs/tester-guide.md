...
This experimental 0.5.1 build keeps up to 32 distinct exercise pictures per app on the phone. Additional pictures show as unavailable. Reopen Info to retry an interrupted download.
...
Free Training support is included in 0.5.1 but remains UNKNOWN on physical hardware. Active 2 testers should look for Lifto under **Workout > Free Training > Settings > More > Data Page > Add Page** and report the exact result.
