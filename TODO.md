...
- Restored the heart icon beside native Workout BPM.
...
- [ ] Await normal-use feedback on startup and per-set synchronization on Active 3 Premium firmware 6.3.13.5.
