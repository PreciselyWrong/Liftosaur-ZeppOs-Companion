...
function fixture() {
  ...
  const env = {
    ...
    workoutDiagnostics: { record() {} }, WORKOUT_DIAGNOSTIC_CODES: { ACTION_TAP: 'ACTION_TAP', RENDER_START: 'RENDER_START', RENDER_END: 'RENDER_END' },
  ...
  return { env, calls, timers, get buttonProps() { return buttonProps; }, set inClick(value) { inClick = value; } };
}
