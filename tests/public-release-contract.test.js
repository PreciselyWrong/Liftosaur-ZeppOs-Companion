...
test('release surfaces agree on version 0.5.7 and code 43', () => {
  ...
  assert.equal(app.app.version.code, 43);
  for (const document of publicDocs) assert.match(document, /0\.5\.7/);
});
