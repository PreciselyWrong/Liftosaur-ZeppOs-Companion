...
test('release surfaces agree on version 0.5.8 and code 44', () => {
  ...
  assert.equal(app.app.version.code, 44);
  for (const document of publicDocs) assert.match(document, /0\.5\.8/);
});
