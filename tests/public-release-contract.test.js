...
test('published preview documentation carries the current Companion QR expiry', () => {
  ...
  for (const document of [readme, testerGuide]) {
    ...
    assert.match(document, /2026-09-15 at 04:46:36 UTC/);
    assert.match(document, /06:46:36 (?:CEST|Central European Summer Time)/);
...
test('the two public apps have tracked preview QR assets in the README', () => {
  ...
  assert.match(readme, /2026-09-15 at 04:47:40 UTC/);
  assert.match(readme, /06:47:40 CEST/);
});
