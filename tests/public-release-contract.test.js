...
test('release surfaces agree on version 0.5.9 and code 45', () => {
  ...
  assert.equal(app.app.version.code, 45);
  for (const document of publicDocs) assert.match(document, /0\.5\.9/);
});
