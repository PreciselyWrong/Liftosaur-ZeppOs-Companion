...
test('release surfaces agree on version 0.5.6 and code 42', () => {
  ...
  assert.equal(app.app.version.code, 42);
  for (const document of publicDocs) assert.match(document, /0\.5\.6/);
});
