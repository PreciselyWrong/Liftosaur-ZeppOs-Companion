...
- Version 0.5.5 beta: both apps run timed and unilateral sets, rest countdown warning alerts, and rounded exercise images with white backgrounds in the ready list, workout overview, Info and Prepare. Lifto Workout targets Strength Training and Free Training with App ID 1125789. Timed native lifecycle, alerts and image display require physical validation.
